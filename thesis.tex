...
\input{chapters/chapter5experiment.tex}

%%%%%%%%%%%%%% rozdział 6 - Podsumowanie i wnioski %%%%%%%%%%%%%%%%%
\chapter{Podsumowanie i wnioski}
\input{chapters/chapter6results.tex}
...
\input{chapters/chapter7symbols.tex}

%%%%%%%%%%%%%% rozdział 8 - Źródła %%%%%%%%%%%%%%%%%
\chapter{Źródła}
\input{chapters/chapter8sources.tex}

%%%%%%%%%%%%%% rozdział 9 - Lista dodatkowych plików, uzupełniających tekst pracy %%%%%%%%%%%%%%%%%
\chapter{Lista dodatkowych plików, uzupełniających tekst pracy} 
\input{chapters/chapter9attachments.tex}
