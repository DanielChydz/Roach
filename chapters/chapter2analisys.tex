...
\captionof{figure}{Poglądowy schemat dysku enkodera absolutnego z 3-bitowym kodem Graya (Bibliografia:~\cite{bib:tarczaenkoderaabsolutnego})}
...
\begin{center}
  ...
  \captionof{figure}{Zobrazowanie zasady działania enkodera magnetycznego dla tarczy z jednym rzędem (Bibliografia:~\cite{bib:obrazekenkoderamagnetycznego})}
...
\begin{center}
  ...
  \captionof{figure}{Genealogia algorytmów MPC (Bibliografia:~\cite{bib:regulatormpc})}
