...
upperThreshold = abs(dataTable.Var4);
lowerThreshold = abs(dataTable.Var5);
mean = abs(dataTable.Var6);
standardDeviation = abs(dataTable.Var7);
...
plot(timeVector, upperThreshold, 'LineStyle', ':', 'Color', 'red');
plot(timeVector, lowerThreshold, 'LineStyle', ':', 'Color', 'red');
plot(timeVector, mean, 'LineStyle', '-.');
...
legend({'Lewy silnik', 'Prawy silnik', 'Górna granica', 'Dolna granica', 'Średnia'}, 'Location', 'northwest')
